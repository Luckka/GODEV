...
class LikeAnimation extends StatefulWidget {
  ...
  const LikeAnimation({super.key, required this.child, required this.isAnimating,this.duration = const Duration(milliseconds: 150), this.smallLike = false,required this.onEnd,});
