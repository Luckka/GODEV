...
class _PostCardWidgetState extends State<PostCardWidget> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(create: (BuildContext context) => widget.homeBloc..add(InitialEvent()),
      child: Builder(
            ...
            children: [
                              ...
                              builder: (context) => Dialog(
                                child: ListView(
                                    ...
                                    children: ['Delete']
                                        .map((e) => InkWell(
                                      onTap: () {
                                        widget.homeBloc.add(DeletePostEvent(postId: widget.snap['postId']));
              ...
              Row(
                children: [
                  ...
                  IconButton(
                      onPressed: () {
                        Modular.to.pushNamed('/comments?snap=${widget.snap['postId']}');
                      },
                      icon: const Icon(
